...
public class UsersTest {
    ...
    public void getEndpoint() {
        try {
            HttpResponse<String> response = Unirest.get("http://localhost:8080/public/test")
                    ...
                    .asString();
            Assert.assertEquals("passed",response.getBody());
    ...
    public void postEndpoint() {
        try {
            HttpResponse<String> response = Unirest.post("http://localhost:8080/public/test")
                    .header("authorization", "Bearer eyJ0eXAiOiJKV1QiLCJub25jZSI6IlZueWVsS093eDl0VGVad0syV0UyUWM1azVwUVc5S01JZ1pOVWNPa3drdU0iLCJhbGciOiJSUzI1NiIsIng1dCI6IkhsQzBSMTJza3hOWjFXUXdtak9GXzZ0X3RERSIsImtpZCI6IkhsQzBSMTJza3hOWjFXUXdtak9GXzZ0X3RERSJ9..EiYXvXsZcZdMBuu5rpEP4xbiLiKH8zRj1bJnBg_swyebuB83PaRJeSaqxQgGx4FHnXIisy5kPeuyIPD-cYSMQrkiL_y-Pay5LmYX1wj-dvQ_X2prqP4OVkarLWzhiBz8N2_Wrcbyld1YTp1VsaZgYacMDQBkOS_IrlJwcfm-ROx1t5rV_mxU-tpg0r8ufjokVWhNvFIyWNkDRAv_1bNQAEqtliEQwhn4cTW5ov3B8ZdffNW7T7ilsS38RGllSV3eExNHwXEI5lJjTrvyg7KdGuvHAKVOhItVq56hOiwpUm6tmAuGFfvQ4k8FAGrSHKQ_c_5jrRQ-FslJhCd3eKdb5Q")
                    .header("cache-control", "no-cache")
                    .body("")
                    .asString();
