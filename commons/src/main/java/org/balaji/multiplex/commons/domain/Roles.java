...
public enum Roles {
	...
	ROLE_VENDOR_USER("VENDOR_USER"), ROLE_TRADES_USER("TRADES_USER"),
	ROLE_ANY_USER("USER", ROLE_TRADES_USER, ROLE_VENDOR_USER),
	ROLE_TRADES_ADMIN("TRADES_ADMIN", ROLE_TRADES_USER),
	ROLE_VENDOR_ADMIN("VENDOR_ADMIN", ROLE_VENDOR_USER),
	ROLE_USER_ADMIN("USER_ADMIN", ROLE_TRADES_ADMIN, ROLE_VENDOR_ADMIN, ROLE_ANY_USER),
